...
export default function UserMenu() {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className="flex items-center gap-2.5 p-1 pr-3 rounded-full
      ...
      {open && (
        <div
          className="absolute right-0 top-full mt-2 w-64 rounded-2xl p-3 z-50 animate-fadeUp"
          style={{
            background: "#0f1420",
        ...
        >
          ...
          <div className="mx-2 mb-2 p-3 rounded-xl bg-white/3 border border-white/5">
            ...
            <div className="flex gap-4">
              <div className="text-center">
                <p className="font-display text-lg font-bold text-white/70">{personalCards.length}</p>
                <p className="font-mono text-[9px] text-white/25 uppercase tracking-wide">My Cards</p>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-xl
                       font-mono text-xs text-red-400/70 uppercase tracking-widest
                       hover:bg-red-400/8 hover:text-red-400
